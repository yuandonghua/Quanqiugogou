			...
			throws IllegalArgumentException, IllegalAccessException
	{
		...
		for (T t : datas)
		{
			...
			for (Field field : fields)
			{
				...
				if (field.getAnnotation(TreeNodeCode.class) != null)
				{
					field.setAccessible(true);
					code = (String) field.get(t);
				}
				...
				if (field.getAnnotation(TreeNodeTypeAorB.class) != null)
				{
					field.setAccessible(true);
					type2 = field.getInt(t);
				}
			}
			node = new Node(id, pid, label,type,type2,code);
			nodes.add(node);
		}// for end
