...
public class FindActivity extends Activity {
	...
	public void initLayout() {
		...
		findViewById(R.id.imageButton2).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (HttpConn.isLogin) {
					startActivity(new Intent(getBaseContext(),EntityshopActivity.class));
		...
		//返回
		((ImageView) findViewById(R.id.scroe_back)).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				finish();
			}
		...
		public void handleMessage(Message msg) {
			...
			case 2:
				if(Score2 > Score){
					...
					Toast.makeText(FindActivity.this, "今天已签到，明天再来吧！", Toast.LENGTH_SHORT).show();
					HttpConn.getScore = true;
				}
				break;
			case 3:
