...
public class PayUtil {
	...
	String titleStr,detailStr,priceStr;  //订单 标题 描述 价格
	
	public PayUtil(Activity activity, 
			String titleStr,String detailStr,String priceStr,
	...
	public void pay() {
		...
		// 订单
		String orderInfo = getOrderInfo(titleStr, detailStr, priceStr); //订单 标题 描述 价格
